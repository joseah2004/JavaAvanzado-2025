...
public class HashMapApp {
    ...
    public static void main(String[] args) {
        ...
        Producto pc = new Producto("PC000123", "Ordenador portátil", 800.0f);//la clave seria referencia
        hashMap.put("PC000123", pc);
        hashMap.put("PC000234", new Producto("PC000234", "Ordenador compacto", 400.0f));

        //no puede haber dos calvs iguales(primera columna no puede tener valores repetidos)
        
        Producto pc1 = new Producto("PC000123", "Ordenador portátil", 800.0f);
        hashMap.put("PC000123", pc1);
